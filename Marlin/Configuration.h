 ...
 *
 */
#define TEMP_SENSOR_0 1 // I'm using PT100. Set 1 for stock thermistor
...
#define TEMP_SENSOR_BED 1 // I'm using SSR. For Standard heater set to 1
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 12.52f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1263f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0497f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0784f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //Original = true I'm using Optical Endstop, so - false
